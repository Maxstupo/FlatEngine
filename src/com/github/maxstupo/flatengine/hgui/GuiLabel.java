...
public class GuiLabel extends GuiContainer {
    ...
    public int hashCode() {
        ...
        result = prime * result + (autoSizeHeight ? 1231 : 1237);
        result = prime * result + autoSizeSpacing;
        result = prime * result + (autoSizeWidth ? 1231 : 1237);
        result = prime * result + minAutoSizeHeight;
        result = prime * result + minAutoSizeWidth;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        GuiLabel other = (GuiLabel) obj;
        if (autoSizeHeight != other.autoSizeHeight)
            return false;
        if (autoSizeSpacing != other.autoSizeSpacing)
            return false;
        if (autoSizeWidth != other.autoSizeWidth)
            return false;
        if (minAutoSizeHeight != other.minAutoSizeHeight)
            return false;
        if (minAutoSizeWidth != other.minAutoSizeWidth)
            return false;
        if (text == null) {
            if (other.text != null)
                return false;
